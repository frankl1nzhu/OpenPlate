...
import { analyzeQuickRecordPhoto } from '../lib/llm'
    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center px-4">
      <div className="bg-white w-full max-w-lg rounded-2xl max-h-[85vh] flex flex-col">
        ...
        <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between shrink-0">
          <h3 className="font-medium">AI快速记录</h3>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3">
          ...
          {stage === 'processing' && (
            <div className="flex flex-col items-center py-12 gap-4">
              ...
              <div className="text-xs text-gray-400">AI正在分析食物总营养成分</div>
            </div>
          )}
          ...
          {stage === 'verify' && editNutrients && (
            <>
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                ...
                <div className="text-xs text-amber-600 mt-1">请核实以下总营养数据，确认后将添加到今日记录</div>
              </div>
              ...
              {/* Name */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">记录名称</label>
                <input
                  type="text"
                  value={editName}
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-xs text-gray-500">主要为完全蛋白来源</span>
              </label>

              {/* Macros */}
              <div className="space-y-2">
                <h4 className="text-sm font-medium text-gray-700">总营养素</h4>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 bg-blue-500 text-white font-medium rounded-lg disabled:opacity-50"
                >
                  {submitting ? '添加中...' : '确认添加'}
                </button>
              </div>
